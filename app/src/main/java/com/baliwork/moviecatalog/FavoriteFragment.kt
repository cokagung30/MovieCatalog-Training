...
import com.baliwork.moviecatalog.favoriteui.MovieFavoriteFragment
import com.baliwork.moviecatalog.favoriteui.TvShowFavoriteFragment
...
class FavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        page.add(FragmentPagerItem.of("Tv Show", TvShowFavoriteFragment::class.java))
